...
CubeMesh *createCubeMesh()
{
  ...
  newCube->mat_ambient[1] = 0.0;
  newCube->mat_ambient[2] = 0.0;
  newCube->mat_ambient[3] = 1.0;
  newCube->mat_specular[0] = 0.5;
  newCube->mat_specular[1] = 0.5;
  newCube->mat_specular[2] = 0.5;
  newCube->mat_specular[3] = 1.0;
  newCube->mat_diffuse[0] = 0.01;
  newCube->mat_diffuse[1] = 0.0;
  newCube->mat_diffuse[2] = 0.001;
  newCube->mat_diffuse[3] = 1.0;
  newCube->mat_shininess[0] = 100.0;
